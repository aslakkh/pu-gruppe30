...
export default class CircularProgress extends Component {
    ...
    //TODO if goal is expired, set percent to zero and add string expired to goalstring. AND if flag = false, do not record time.
    //TODO check if expired goal is stored in oldgoals.
